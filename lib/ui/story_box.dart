...
class _StoryBoxState extends State<StoryBox> {
  ...
  _StoryBoxState() {
    storyList.add(StoryModel(
        "Captain",
        "http://static.shoplightspeed.com/shops/609551/files/002433978/dynamic-discs-dyemax-marvel-captain-america-truth.jpg",
        "http://static.shoplightspeed.com/shops/609551/files/002433978/dynamic-discs-dyemax-marvel-captain-america-truth.jpg"));
    storyList.add(StoryModel(
        "Iron Man",
        "https://cdn.images.express.co.uk/img/dynamic/36/590x/Avengers-Iron-Man-was-almost-played-by-another-major-star-936289.jpg",
        "https://cdn.images.express.co.uk/img/dynamic/36/590x/Avengers-Iron-Man-was-almost-played-by-another-major-star-936289.jpg"));
    storyList.add(StoryModel(
        "Black Widow",
        "https://am24.akamaized.net/tms/cnt/uploads/2015/06/black_widow_avengers_age_of_ultron-wide-1280x800.jpg",
        "https://am24.akamaized.net/tms/cnt/uploads/2015/06/black_widow_avengers_age_of_ultron-wide-1280x800.jpg"));
    storyList.add(StoryModel(
        "Thanos",
                      ...
                      return new Stack(
                        children: <Widget>[
                          ...
                          new Positioned(
                            top: 10.0,
                            left: 10.0,
                            child: new Container(child: new Text("Text")),
                          ),
                        ],
                      );
                    },
